...
import com.dbvoid.service.backend.AppService;
import com.dbvoid.service.developer.AppCategoryService;
import com.dbvoid.service.developer.AppVersionService;
...
public class AppCheckController {
    ...
    public String getAppInfoList(Model model, HttpSession session,
        ...
        List<AppCategory> categoryLevel1List = null;//列出一级分类列表,注:二级分类列表和三级分类列表通过异步ajax请求
        ...
        int totalCount = 0;
        try {
            appService.getAppInfoCount(querySoftwareName, queryCategoryLevel1, queryCategoryLevel2, queryCategoryLevel3, queryFlatformId);
        }catch (Exception e){
            e.printStackTrace();
        }
